  ...
  <Card sx={{ order: -1, mr: 2, mt: 6, width: 250 }}>
    <CardContent>
      ...
      <FilterList label="Категории" icon={<CategoryIcon />}>
        <FilterListItem label="Математический анализ" value={{ category_id: 2 }} />
        <FilterListItem label="Дифференциальные уравнения" value={{ category_id: 3 }} />
        <FilterListItem label="Математическая физика" value={{ category_id: 4 }} />
      </FilterList>
